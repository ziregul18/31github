            ...
            <div class="row align-items-center justify-content-center h-100">
                <div class="col-md-5">
                    <div class="card p-3">
                        <div class="card-body">
                            <div class="auth-logo">
                                <img src={{ asset("admin_files/assets/images/logo.png ")}} class="img-fluid  rounded-normal  darkmode-logo" alt="logo">
                                <img src={{ asset("admin_files/assets/images/logo-dark.png") }} class="img-fluid rounded-normal light-logo" alt="logo">
                            </div>
